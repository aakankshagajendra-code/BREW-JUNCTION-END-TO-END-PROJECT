...
cursor=db.cursor()
cursor.execute("CREATE DATABASE IF NOT EXISTS BREWJUNCTION")
cursor.execute("USE BREWJUNCTION")
...
PRODUCTS = {
    ...
    4: ("Caramel Coffee", 60),
    5: ("Vanilla Coffee", 60),
    6: ("Hazelnut Coffee", 60),
    7: ("Butterscotch Coffee", 60),
    8: ("Chocolate Coffee", 60)
}
...
while True:
    ...
    if choice == '1':
        try:
            shop_no = int(input("Enter Shop No (1-8): "))

            if shop_no < 1 or shop_no > 8:
